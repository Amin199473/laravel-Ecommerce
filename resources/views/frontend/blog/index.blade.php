                        ...
                        <div class="blog_details">
                            ...
                            <ul class="blog-info-link">
                                <li>
                                    ...
                                    <span class="badge badge-dark" style="background-color: rgb(253, 253, 253)"><a href="{{ route('tagPosts',$tag->id)}}">{{ $tag->name }}</a></span>
                                    @endforeach
                                </li>
                ...
                <div class="blog_right_sidebar">
                    ...
                    <aside class="single_sidebar_widget popular_post_widget">
                        ...
                        <div class="media post_item">
                            <img src="{{ asset('post-image/'.$post->image) }}" alt="post" style="width: 70px">
                            <div class="media-body">
                                <a href="{{ route('singlePost',[$post->id,$post->slug]) }}">
