        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="row">
                    ...
                    @endforeach
                    <div class="row">
                        <div class="col-md-12">{{$products->appends(Illuminate\Support\Facades\request::except('page'))->links('vendor.pagination.bootstrap-4')}}</div>
                    </div>
                </div>
            </div>
        </div>
