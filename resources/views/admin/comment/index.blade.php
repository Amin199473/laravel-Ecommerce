            ...
            <div class="col-sm-6">
                <div class="row">
                    <div class="col-ms-4 ml-2">
                        <h1><i class="fa fa-list-alt" aria-hidden="true"></i>&nbsp; Comments</h1>
                    </div>
                    <div class="col-ms-4 ml-2">
                        <button type="button" class="btn btn-block btn-outline-info" data-toggle="modal" data-target="#exampleModal">Remove All Comments</button>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting text-center" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="text-align: center">Comment</th>
                                                <th class="sorting text-center" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="text-align: center">Post</th>
                                                <th class="sorting text-center" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="text-align: center">Approved</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr {{ $key/2 === 0 ? 'class="even"':'class="odd"' }}>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('showComment',[$comment->id]) }}"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                    <a href="" data-toggle="modal" data-target="#deleteModal" data-commentid="{{ $comment->id }}"><i class="fa fa-trash" style="color: rgb(199, 53, 53)"></i></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure for delete this Comment?
                </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Delete All Comments</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                Are you sure for delete All Comments?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">cancel</button>
                <form action="" method="POST">
...
<script>
    ...
    $('#exampleModal').on('show.bs.modal', function(event) {
        ...
        let modal = $(this)
        modal.find('form').attr('action', 'comment-deleteAll')
    })
    ...
    $('#deleteModal').on('show.bs.modal', function(event) {
        ...
        modal.find('form').attr('action', 'comment/' + comment_id + '/delete')
    })
