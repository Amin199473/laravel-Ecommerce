                ...
                <div class="row">
                    ...
                    <div class="col-ms-4 ml-2">
                        <a href="{{ route('category.create') }}">
                            <button type="button" class="btn btn-block btn-outline-info">Add New Category</button>
                        </a>
                    </div>
                    <div class="col-ms-4 ml-2">
                        <button type="button" class="btn btn-block btn-outline-info" data-toggle="modal" data-target="#exampleModal">Remove All Categories</button>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting text-center" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="text-align: center">Parent</th>
                                                <th class="sorting text-center" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="text-align: center">name</th>
                                                <th class="sorting text-center" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="text-align: center">Related Category</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr {{ $key/2 === 0 ? 'class="even"':'class="odd"' }}>
                                                ...
                                                <td class="text-center">
                                                    @if($category->model_type == 'App\Models\Post')
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="" data-toggle="modal" data-target="#deleteModal" data-categoryid="{{ $category->id }}"><i class="fa fa-trash" style="color: rgb(199, 53, 53)"></i></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Delete All Categories</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                Are you sure for delete All Categories?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">cancel</button>
                <form action="" method="POST">
...
<script>
    ...
    $('#exampleModal').on('show.bs.modal', function(event) {
        ...
        let modal = $(this)
        modal.find('form').attr('action', 'category-deleteAll')
    })
