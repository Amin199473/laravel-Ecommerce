            ...
            <div class="col-sm-6">
                <div class="row">
                    <div class="col-ms-6 ml-2">
                        <h1><i class="fa fa-list-alt" aria-hidden="true"></i>&nbsp;Update Coupons</h1>
                    </div>
                    <div class="col-ms-6 ml-2">
                    ...
                    <div class="card card-primary">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="code" value="{{ $coupon->code }}" id="code" placeholder="Enter Code">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                                    <input type="text" value="{{ $coupon->expiry_date }}" name="expiry_date" class="form-control datetimepicker-input" data-target="#reservationdatetime" />
        ...
        type.addEventListener('change', () => {
            if (type.value == 'fixed') {
                ...
                text1.innerHTML =
                    ...
                    "<input type='text' class='form-control' value='{{ $coupon->value }}' id='value' name='value' placeholder='Value'>";
                ...
                text2.innerHTML =
                    ...
                    "<input type='text' class='form-control' value='{{ $coupon->percent_off }}' id='percent_off' name='percent_off' placeholder='percent off'>";
