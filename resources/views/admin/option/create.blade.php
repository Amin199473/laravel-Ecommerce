...
@section('head')
<title>Add Options Product</title>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('option.store') }}" method="POST" id="options">
                    @csrf
                    @method('POST')
                    <div class="card-body">
                        <div class="form-group">
                            <label for="option_name">Option Name</label>
                            <input class="form-control" value="{{ old('option_name') }}" name="option_name" id="option_name" placeholder="Enter Option Name">
                        </div>
                        <div class="form-group">
                            <label for="option_value">option Value</label>
                            <input type="text" value="{{ old('option_value') }}" data-role="tagsinput" id="option_value" name="option_value" class="form-control" placeholder="Enter Option Value">
                        </div>
                        <div class="form-group">
