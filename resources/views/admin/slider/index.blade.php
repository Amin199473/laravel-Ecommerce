                ...
                <div class="row">
                    ...
                    <div class="col-ms-4 ml-2">
                        <a href="{{ route('slider.create') }}">
                            <button type="button" class="btn btn-block btn-outline-info">Add New Slider</button>
                        </a>
                    </div>
                    <div class="col-ms-4 ml-2">
                        <button type="button" class="btn btn-block btn-outline-info" data-toggle="modal" data-target="#exampleModal">Remover All Slider</button>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title">List All Sliders</h2>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Subtitle</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr {{ $key/2 === 0 ? 'class="even"':'class="odd"' }}>
                                                ...
                                                <td>
                                                    <img src="{{ asset('slider-image/'.$slider->image) }}" alt="" width="70px">
                                                </td>
                                                <td>{{ $slider->button }}</td>
                                                <td>{{ $slider->link_button }}</td>
                                                <td>
                                                    @if($slider->status == 1)
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="{{ route('slider.edit' ,$slider->id) }}"><i class="fa fa-pencil" aria-hidden="true" style="color: rgb(119, 0, 255)"></i></a>
                                                    <a href="" data-toggle="modal" data-target="#deleteModal" data-sliderid="{{ $slider->id }}"><i class="fa fa-trash" style="color: rgb(199, 53, 53)"></i></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure for delete this Slider?
                </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Delete All Slider</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                Are you sure for delete All Sliders?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">cancel</button>
                <form action="" method="POST">
...
<script>
    ...
    $('#exampleModal').on('show.bs.modal', function(event) {
        ...
        let modal = $(this)
        modal.find('form').attr('action', 'slider-deleteAll')
    })

    //script for submit form single delete action
    $('#deleteModal').on('show.bs.modal', function(event) {
        let button = $(event.relatedTarget)
        let slider_id = button.data('sliderid')

        let modal = $(this)
        //   modal.find('.modal-footer #userId').val(userId)
        modal.find('form').attr('action', 'slider/' + slider_id)
    });
