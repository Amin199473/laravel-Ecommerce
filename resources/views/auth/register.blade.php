                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input class="mt-2" type="radio" name="gender" id="gender" value="male" required>Male
                                <input class="mt-2" type="radio" name="gender" id="gender" value="female" required>Female
                                @error('gender')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
