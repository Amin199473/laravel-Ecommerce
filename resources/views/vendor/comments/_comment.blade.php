...
<div id="comment-{{ $comment->getKey() }}" class="media">
    @if(Auth::user())
        ...
        <img class="rounded-circle mr-3" src="{{ asset('avatar-image/'.Auth::user()->profile->avatar) }}" alt="{{ $comment->commenter->name ?? $comment->guest_name }} Avatar" width="50px">
        @else
        <img class="rounded-circle mr-3" src="{{ asset('backend/dist/img/avatar3.png') }}" alt="{{ $comment->commenter->name ?? $comment->guest_name }} Avatar" width="50px">
        @endif
    @else
    <img class="rounded-circle mr-3" src="{{ asset('backend/dist/img/avatar3.png') }}" alt="{{ $comment->commenter->name ?? $comment->guest_name }} Avatar" width="50px">
    @endif
